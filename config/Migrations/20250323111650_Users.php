...
class Users extends AbstractMigration
{
    ...
    public function change(): void
    {
        ...
        $table->addColumn('training_program', 'text', ['null' => true])
            ->addColumn('exclusive_from', 'text', ['null' => true])
            ->addColumn('exclusive_to', 'text', ['null' => true])
            ->addColumn('number_of_hours', 'text', ['null' => true])
            ->addColumn('type', 'text', ['null' => true])
            ->addColumn('conducted_by', 'text', ['null' => true])
            ->addColumn('created', 'datetime')
            ->addColumn('modified', 'datetime')
            ->create();

        $table = $this->table('organization');
        $table->addColumn('name_of_organization', 'text', ['null' => true])
            ->addColumn('exclusive_from', 'text', ['null' => true])
            ->addColumn('exclusive_to', 'text', ['null' => true])
            ->addColumn('number_of_hours', 'text', ['null' => true])
            ->addColumn('position', 'text', ['null' => true])
            ->addColumn('created', 'datetime')
            ->addColumn('modified', 'datetime')
            ->create();
        ...
        $table->addColumn('start_from', 'text', ['null' => true])
            ->addColumn('upto', 'text', ['null' => true])
            ->addColumn('position', 'text', ['null' => true])
            ->addColumn('department_id', 'integer', ['null' => true])
            ->addColumn('monthly_salary', 'text', ['null' => true])
            ->addColumn('salary_grade', 'text', ['null' => true])
            ->addColumn('status_of_appointment', 'text', ['null' => true])
            ->addColumn('government_service', 'text', ['null' => true])
            ->addColumn('created', 'datetime')
            ->addColumn('modified', 'datetime')
        ...
        $table->addColumn('speciality_laws', 'text', ['null' => true])
            ->addColumn('rating', 'text', ['null' => true])
            ->addColumn('date_of_examination', 'text', ['null' => true])
            ->addColumn('place_of_examination', 'text', ['null' => true])
            ->addColumn('license_number', 'text', ['null' => true])
            ->addColumn('date_of_validity', 'text', ['null' => true])
            ->addColumn('created', 'datetime')
            ->addColumn('modified', 'datetime')
            ->create();
        ...
        $table->addColumn('family_background', 'string', ['null' => true])
            ...
            ->addColumn('father_surname', 'string', ['null' => true])
            ->addColumn('father_first_name', 'string', ['null' => true])
            ->addColumn('father_middle_name', 'string', ['null' => true])
            ->addColumn('mother_maiden_name', 'string', ['null' => true])
            ->addColumn('mother_first_name', 'string', ['null' => true])
            ->addColumn('mother_middle_name', 'string', ['null' => true])
            ->addColumn('siblings', 'text', ['null' => true])
            ->addColumn('bithdays', 'text', ['null' => true])
            ->addColumn('created', 'datetime')
            ->addColumn('modified', 'datetime')
            ->create();
        ...
        $table->addColumn('first_name', 'string')
            ...
            ->addColumn('agency_employee_number', 'string', ['null' => true])
            ->addColumn('citizenship', 'string')
            ->addColumn('residential_address', 'string', ['null' => true])
