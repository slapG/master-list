...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Vocational'), ['action' => 'edit', $vocational->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Vocational'), ['action' => 'delete', $vocational->id], ['confirm' => __('Are you sure you want to delete # {0}?', $vocational->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Vocational'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Vocational'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="vocational view content">
            <h3><?= h($vocational->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Vocational Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($vocational->employees)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($vocational->employees as $employees) : ?>
                        <tr>
