<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="importModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
        <div class="modal-content border-0 shadow-lg rounded-lg" style="overflow: hidden;">
            <div class="modal-header text-white" style="background: linear-gradient(45deg, #28a745, #218838); border-top-left-radius: 0.3rem; border-top-right-radius: 0.3rem;">
                <h5 class="modal-title" id="importModalLabel"><i class="fas fa-user-plus mr-2"></i>Add User</h5>
            ...
            <div class="modal-body" style="background-color: #f8f9fa; padding: 2rem;">
                <?= $this->Form->create(null, ['id' => 'addUserForm']) ?> 
