            ...
            <div class="row">
                ...
                <div class="row">
                    <div class="col-md-3 mt-4">
                        ...
                        <?= $this->Form->input('speciality.speciality_laws.0', ['class' => 'form-control', 'disabled']) ?>
                    </div>
                    <div class="col-md-1 mt-4">
                        <?= $this->Form->label('speciality.rating') ?>
                        <?= $this->Form->input('speciality.rating.0', ['class' => 'form-control', 'disabled', ]) ?>
                    </div>
                    ...
                    <div class="col-md-3 mt-4">
                        ...
                        <?= $this->Form->input('speciality.place_of_examination.0', ['class' => 'form-control', 'disabled', ]) ?>
                    </div>
                    <div class="col-md-1">
                        <?= $this->Form->label('speciality.license_number') ?>
                        <?= $this->Form->input('speciality.license_number.0', ['class' => 'form-control', 'disabled', ]) ?>
                    </div>
                    <div class="col-md-2 mt-4">
                ...
                <div class="row">
                    <div class="col-md-4 mt-4">
                        ...
                        <?= $this->Form->input('organization.name_of_organization.0', ['class' => 'form-control','disabled',]) ?>
                    </div>
                    <div class="col-md-2 mt-4">
                    ...
                    <div class="col-md-1">
                        ...
                        <?= $this->Form->input('organization.number_of_hours.0', ['class' => 'form-control','disabled',]) ?>
                    </div>
                    <div class="col-md-3 mt-4">
                        <?= $this->Form->label('organization.position') ?>
                        <?= $this->Form->input('organization.position.0', ['class' => 'form-control' ,'disabled',]) ?>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-3 mt-4">
                        ...
                        <?= $this->Form->input('lnd.training_program.0', ['class' => 'form-control', 'disabled',]) ?>
                    ...
                    <div class="col-md-1">
                        ...
                        <?= $this->Form->input('lnd.number_of_hours.0', ['class' => 'form-control','disabled', ]) ?>
                    ...
                    <div class="col-md-1 mt-4">
                        ...
                        <?= $this->Form->input('lnd.type.0', ['class' => 'form-control','disabled', ]) ?>
                    ...
                    <div class="col-md-3 mt-4">
                        ...
                        <?= $this->Form->input('lnd.conducted_by.0', ['class' => 'form-control','disabled', ]) ?>
                ...
                <div class="row">
                    <div class="col-md-4">
                        ...
                        <?= $this->Form->input('other_information.special_skill.0', ['class' => 'form-control', 'disabled',]) ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <?= $this->Form->input('other_information.non_academic_distinction.0', ['class' => 'form-control','disabled', ]) ?>
                    ...
                    <div class="col-md-4">
                        ...
                        <?= $this->Form->input('other_information.membership.0', ['class' => 'form-control','disabled',]) ?>
