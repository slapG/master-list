 ...
 * @var iterable<\App\Model\Entity\OtherInformation> $otherInformation
 */
?>
<div class="otherInformation index content">
    ...
    <div class="table-responsive">
        <table>
            ...
            <tbody>
                <?php foreach ($otherInformation as $otherInformation): ?>
                <tr>
