...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Speciality'), ['action' => 'edit', $speciality->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Speciality'), ['action' => 'delete', $speciality->id], ['confirm' => __('Are you sure you want to delete # {0}?', $speciality->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Specialities'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Speciality'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="specialities view content">
            ...
            <div class="related">
                ...
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($speciality->employees as $employees) : ?>
                        <tr>
