...
<div class="row">
    <aside class="column">
        <div class="side-nav">
            ...
            <?= $this->Html->link(__('Edit Secondary'), ['action' => 'edit', $secondary->id], ['class' => 'side-nav-item']) ?>
            <?= $this->Form->postLink(__('Delete Secondary'), ['action' => 'delete', $secondary->id], ['confirm' => __('Are you sure you want to delete # {0}?', $secondary->id), 'class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('List Secondary'), ['action' => 'index'], ['class' => 'side-nav-item']) ?>
            <?= $this->Html->link(__('New Secondary'), ['action' => 'add'], ['class' => 'side-nav-item']) ?>
        </div>
    </aside>
    <div class="column-responsive column-80">
        <div class="secondary view content">
            <h3><?= h($secondary->id) ?></h3>
            <table>
                <tr>
                    <th><?= __('Secondary Name') ?></th>
            ...
            <div class="related">
                ...
                <?php if (!empty($secondary->employees)) : ?>
                <div class="table-responsive">
                    <table>
                        ...
                        <?php foreach ($secondary->employees as $employees) : ?>
                        <tr>
